...
class SquareRootServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SquareRoot = channel.unary_unary(
                '/test.SquareRootService/SquareRoot',
...
def add_SquareRootServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'test.SquareRootService', rpc_method_handlers)
...
class SquareRootService(object):
    ...
    def SquareRoot(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/test.SquareRootService/SquareRoot',
